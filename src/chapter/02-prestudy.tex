...
Tweets can be found using an HTTPS search request with the search query in the format URLE [1]. Searching for <URLE search query> can be done with the following request.
