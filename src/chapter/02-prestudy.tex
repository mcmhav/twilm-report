...
\subsection{MovieTweetings}\label{subsec:MovieTweetings}
...
\subsection{Probabilistic Neighborhood Selection}
A often used approach when recommending items is a neighborhood-based collaborative filtering. This approach often has the issue that it over-specializes and makes concentrated biases when recommending. This can be handled with a probabilistic approach when selecting neighbors\cite{probcobfilter}.


\subsection{Predicting User Ratings with Matrix Factorization}

\cite{predusingmatrix}
